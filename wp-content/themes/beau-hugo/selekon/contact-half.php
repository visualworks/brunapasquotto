    ...
    <div class="container">
        <?php if (!$title == '' || !$content=='') {?>
            <div class="description col-md-6 col-sm-12 col-xs-12">
                <?php if (!$title=='') {?>
                      <h2 class="pull-left"><?php echo esc_html($title)?></h2>
                <?php }
                if (!$content == '') {?>
        ...
        <div class="beau-form col-md-6 col-sm-6 col-xs-12">
        <div class="success-form-message"></div>
        <form class="hugo-contact" action="#" method="post">
            <ul class="beau-contact pull-left form-static col-md-6 col-sm-12 col-xs-12">
...
<style type="text/css">
    .beau-contact li button, .form-comment .beau-contact li button{
        width: 170px;
