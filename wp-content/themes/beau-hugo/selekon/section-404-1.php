<section class="notfound not-found-v1 padding-section">
	<div class="container">
		<div class="description col-md-12 col-sm-12 col-xs-12">
			<h2><?php esc_html_e('Oops! Page not found', 'hugo')?></h2>
			<div class="desc-section">
				<?php esc_html_e('Sorry but the page you are loking for does not exist, have been removed or name changed.','hugo')?><br /><a href="javascript:history.go(-1)"><?php esc_html_e('Go back','hugo')?></a> <?php esc_html_e('or enter the key wirds to search please!','hugo')?>
			</div>
		</div>
