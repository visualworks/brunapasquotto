...
?>
	<ul class="pull-right">
		...
		<li class="sbutton linkedin-cresta-share" id="linkedin-cresta"><a rel="nofollow" href="http://www.linkedin.com/shareArticle?mini=true&amp;url=<?php echo  urlencode(get_permalink( $post->ID )) ?>&amp;title=<?php echo htmlspecialchars(urlencode(html_entity_decode(get_the_title( $post->ID ), ENT_COMPAT, 'UTF-8')), ENT_COMPAT, 'UTF-8') ?>&amp;source=<?php echo esc_url( home_url( '/' )) ?>" title="<?php _e('Share to LinkedIn','hugo')?>" onclick="window.open(this.href,'targetWindow','toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=700,height=450');return false;"><i class="fa fa-linkedin"></i></a><span class="cresta-the-count" id="linkedin-count"><i class="cs c-icon-cresta-spinner animate-spin"></i></span></li>
	</ul>
