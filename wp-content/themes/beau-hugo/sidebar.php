...
<?php
$customsidebar   =  hugo_option('custom_sidebar');
$sidebar_numbers = hugo_option('$sidebar_numbers');
...
if ($customsidebar != NULL && $sidebar_numbers != NULL) {
	$numberWidget = intval($sidebar_numbers);
