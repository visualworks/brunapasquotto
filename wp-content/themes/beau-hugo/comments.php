	...
	<div class="form-comment">
		...
		comment_form(
			array(
			    ...
			    'comment_field' => '<li class="col-md-12 col-sm-12 col-xs-12"><textarea id="comment" name="comment" cols="45" rows="8" aria-required="true" class="required" placeholder="'.esc_html__('Message *','hugo').'"></textarea></li>',
