...
<ul class="pull-left">
<?php the_tags( '<li>'.__('Tags','hugo').':</li><li>', '</li><li>', '</li>' ); ?>
</ul>
<?php
...
?>
	<ul class="pull-right">
		...
		<li class="googleplus-cresta-share" id="googleplus-cresta"><a rel="nofollow" href="https://plus.google.com/share?url=<?php echo  urlencode(get_permalink( $post->ID )) ?>" title="<?php _e('Share to Google Plus','hugo')?>" onclick="window.open(this.href,'targetWindow','toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=700,height=450');return false;"><i class="fa fa-google-plus"></i></a><span class="cresta-the-count" id="googleplus-count"><i class="cs c-icon-cresta-spinner animate-spin"></i></span></li>
	</ul>
</div>