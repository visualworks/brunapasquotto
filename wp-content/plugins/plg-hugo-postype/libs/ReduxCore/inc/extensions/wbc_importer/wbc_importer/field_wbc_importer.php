    ...
    class ReduxFramework_wbc_importer {
        ...
        function __construct($field = array(), $value = '', $parent) {
            ...
            if (!empty($class->demo_data_dir)) {
                ...
                $this->demo_data_url = site_url(str_replace(trailingslashit(str_replace('\\', '/', ABSPATH)), '', str_replace('\\', '/', $this->demo_data_dir)));
            }
        ...
        public function enqueue() {
            ...
            wp_enqueue_script(
                    'redux-field-wbc-importer-js', $this->extension_url . '/field_wbc_importer.js', array('jquery'), time(), true
            );
