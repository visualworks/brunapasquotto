jQuery(document).ready(function ($) {
	...
	function checkCustomSidebar(str){
		if (str) {
			$('#beau_option-sidebar_numbers').closest('tr').show('fast');
		};
		if (!str) {
			$('#beau_option-sidebar_numbers').closest('tr').hide('fast');
		};
	}
